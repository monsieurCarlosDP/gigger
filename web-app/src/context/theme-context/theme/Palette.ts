...
const semanticPaletteLight = {
   ...
   */
  primary: {
    main: colorPaletteLight.black.main,
  },
  secondary: {
...
const muiGreyCustomizedDark = {
  ...
  const semanticPaletteDark = {
     ...
     */
    primary: {
      main: colorPaletteDark.black.main,
    },
    secondary: {
      main: colorPaletteDark.greySimplified.dark,
      light: colorPaletteDark.greySimplified.light,
    },
    success: {
    ...
    lightBackground: {
      main: colorPaletteDark.greySimplified.light,
    },
